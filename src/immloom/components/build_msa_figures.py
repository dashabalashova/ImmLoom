...
def main() -> None:
    ...
    max_id = max(int(p.stem.replace("component_", "")) for p in aln_files)
    width = len(str(max_id))
    for aln_file in aln_files:
        component_id_int = int(aln_file.stem.replace("component_", ""))
        component_id = str(component_id_int).zfill(width)
        ...
        identity_png = figures_dir / f"component_{component_id}_pairwise_identity.png"
        coverage_png = figures_dir / f"component_{component_id}_coverage.png"
